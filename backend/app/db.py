...
DEFAULT_CATEGORIES = [
    ("expense_category1", "伙食支出", 10),
    ("expense_category1", "生活支出", 20),
    ("expense_category1", "水电气话费支出", 30),
    ("expense_category1", "娱乐支出", 40),
    ("expense_category1", "其他支出", 50),
    ("expense_category1", "教育支出", 60),
    ("expense_category1", "服装支出", 70),
    ("income_category", "工资", 10),
    ("income_category", "奖金", 20),
    ("income_category", "投资收益", 30),
